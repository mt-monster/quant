> **数据快照**: 2026-07-26 00:55 GMT+8 ｜ **数据源**: `results/*_checkpoint.json`(权威) + `*_progress_*.log`(实时) + `tri_track_undug_results.csv`
...
| 指标 | 数值 | 说明 |
|---|---|---|
| 累计回测次数 | **7,891** | 全部 32 个 checkpoint 合计 |
...
| 在飞挖掘任务 | **7 个任务** | 7路ds 舰队 (v52b(已完成 23:29), tri_track(已完成 07-26 00:50)) |
...
每一级都是一道硬闸门：**IS 廉价闸门**筛掉 7,849 次（7,849/7891=99.5% 被筛）；**生产相关性关**仅 1 个通过；**平台提交**为 0。42 个候选 ≠ 可提交。
...
| 已提交 alpha | 累计 2088 次 (含研究仿真) | 763 alpha 已提交并完成 |
...
|---|---|---|---|---|---|---|
| equity_kpi_forecast | 312/320 (97.5%) | 🟡 **1.47** | ~83 α/hr | 225 min | **07-26 01:01** | 🔴 0 候选 |
| ml_factor_proj | 264/320 (82.5%) | 🔴 **0.48** | ~71 α/hr | 224 min | **07-26 01:43** | 🔴 0 候选 |
| order_book_imbalance | 312/320 (97.5%) | 🔴 **0.84** | ~83 α/hr | 226 min | **07-26 01:01** | 🔴 0 候选 |
| pv_tech_indicators | 264/320 (82.5%) | 🔴 **0.76** | ~70 α/hr | 225 min | **07-26 01:43** | 🔴 0 候选 |
| quant_factor_lib | 296/320 (92.5%) | 🔴 **0.60** | ~80 α/hr | 222 min | **07-26 01:13** | 🔴 0 候选 |
| techindi_model | 256/320 (80.0%) | 🟡 **1.52** | ~70 α/hr | 220 min | **07-26 01:50** | 🔴 0 候选 |
| web_traffic_engage | 288/320 (90.0%) | 🟢 **2.27** | ~77 α/hr | 224 min | **07-26 01:20** | 🔴 0 候选 |
| workforce_flow_skills | 96/320 (30.0%) | 🟢 **1.60** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
...
| 任务 | 当前进度 | 预期完成 | 置信度 |
|---|---|---|---|
| 🚢 equity_kpi_forecast | 312/320 (98%) | **07-26 01:01** | 中 |
| 🚢 ml_factor_proj | 264/320 (82%) | **07-26 01:43** | 中 |
| 🚢 order_book_imbalance | 312/320 (98%) | **07-26 01:01** | 中 |
| 🚢 pv_tech_indicators | 264/320 (82%) | **07-26 01:43** | 中 |
| 🚢 quant_factor_lib | 296/320 (92%) | **07-26 01:13** | 中 |
| 🚢 techindi_model | 256/320 (80%) | **07-26 01:50** | 中 |
| 🚢 web_traffic_engage | 288/320 (90%) | **07-26 01:20** | 中 |
| 🚢 workforce_flow_skills | 0/320 (0%) | **?** | 低(运行不足30min) |
| ✅ tri_track_undug | 763 alpha | **已完成 (07-26 00:50)** | 已完成(旧脚本) |
...
| 5 | 🚢 ds_web_traffic_engage_tri_web_traffic_en | 288 | 0 | 🟢 **2.27** | - | gate_S/F/M/Ret |
| 6 |  v34_insider_matrix | 72 | 0 | 🟢 **1.95** | - | gate_S/F/M/Ret |
| 7 |  v51_tri_behavioral_signals | 320 | 0 | 🟢 **1.72** | - | gate_S/F/M/Ret |
| 8 | 🚢 ds_workforce_flow_skills_tri_workforce_f | 96 | 0 | 🟢 **1.60** | - | PF:LOW_SUB |
| 9 |  v47_tri_search_interest | 320 | 0 | 🟢 **1.59** | - | gate_S/F/M/Ret |
| 10 | 🚢 ds_techindi_model_tri_techindi_model | 256 | 0 | 🟡 **1.52** | - | gate_S/F/M/Ret |
| 11 | 🚢 ds_equity_kpi_forecast_tri_equity_kpi_fo | 312 | 0 | 🟡 **1.47** | - | gate_S/F/M/Ret |
| 12 |  v53_tri_stock_search_trends | 320 | 0 | 🟡 **1.19** | - | gate_S/F/M/Ret |
| 13 |  v38_sust_profit | 278 | 0 | 🟡 **1.12** | - | gate_S/F/M/Ret |
| 14 |  v38b_sust_rescue | 270 | 0 | 🟡 **1.07** | - | gate_S/F/M/Ret |
| 15 |  v37_other545 | 187 | 0 | 🔴 **0.98** | - | gate_S/F/M/Ret |
| 16 |  v54_tri_event_stock_model | 320 | 0 | 🔴 **0.95** | - | gate_S/F/M/Ret |
| 17 |  v46_tri_insider_trx | 320 | 0 | 🔴 **0.92** | - | gate_S/F/M/Ret |
| 18 |  v42_social | 200 | 0 | 🔴 **0.88** | - | gate_S/F/M/Ret |
| 19 | 🚢 ds_order_book_imbalance_tri_order_book_i | 312 | 0 | 🔴 **0.84** | - | gate_S/F/M/Ret |
| 20 |  v48_tri_acquisition_model | 320 | 0 | 🔴 **0.79** | - | gate_S/F/M/Ret |
| 21 | 🚢 ds_pv_tech_indicators_tri_pv_tech_indica | 264 | 0 | 🔴 **0.76** | - | gate_S/F/M/Ret |
...
| 28 | 🚢 ds_quant_factor_lib_tri_quant_factor_lib | 296 | 0 | 🔴 **0.60** | - | gate_S/F/M/Ret |
| 29 |  v36_stock_cluster | 157 | 0 | 🔴 **0.57** | - | gate_S/F/M/Ret |
| 30 | 🚢 ds_ml_factor_proj_tri_ml_factor_proj | 264 | 0 | 🔴 **0.48** | - | gate_S/F/M/Ret |
...
| 已提交 alpha | **763** 个  |
| 提交结果 | ✅ submitted=763 / ❌ failed=0 |
| 最佳 Sharpe | 不可用 (CSV 无指标) |
| 分轨分布 | explore 438 / improve 221 / misc 104 |
| 时间范围 | 2026-07-25 11:58:04 ~ 2026-07-26 00:50:10 |
...
| 预期完成 | **已完成 (07-26 00:50)** (基于每分片 ~300s × 6 剩余 / CONCURRENCY=3, 粗估) |
| 信号举例 | `unsystematic_risk_last_90_days` zscore × subindustry / `correlation_last_360_days_spy` flip / `pcr_vol_60` 救援 |

> ⚠️ **已完成但缺回测指标**：旧脚本不写 checkpoint，仅 CSV 有提交记录（763 alpha，全部 done）。已改造 `tri_track_undug.py`，下次运行时将产出 checkpoint + 进度日志 + IS 回测指标。
...
| Ret(收益) | **6,147** | 20.6% |  |
| TVR(换手率) | **3,125** | 10.5% |  |
| submit_failed | **664** | 2.2% |  |
| PF:子宇宙Sharpe | **301** | 1.0% | 主因 PF:LOW_SUB_UNIVERSE_SHARPE (218次) |

> **PF:子宇宙 Sharpe 是头号平台失败闸门** (301 次)，印证'在子宇宙层面优化中性化/约束'是攻坚方向。IS 指标失败(夏普/拟合/换手/收益)合计 28,934 次，submit_failed 664 次(多为研究仿真本地拒，非平台 429)。
...
---
*报告由 `build_md_report.py` 从真实 checkpoint/progress/CSV 文件程序化生成 · 快照 2026-07-26 00:55 GMT+8 · 数字均来自文件实测，未编造。*
