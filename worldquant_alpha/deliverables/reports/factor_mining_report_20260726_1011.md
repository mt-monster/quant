> **数据快照**: 2026-07-26 10:11 GMT+8 ｜ **数据源**: `results/*_checkpoint.json`(权威) + `*_progress_*.log`(实时) + `tri_track_undug_results.csv`
...
| equity_kpi_forecast | 320/320 (100.0%) | 🟡 **1.47** | ~84 α/hr | 230 min | **?** | 🔴 0 候选 |
...
| ml_factor_proj | 320/320 (100.0%) | 🔴 **0.48** | ~61 α/hr | 317 min | **?** | 🔴 0 候选 |
| news_sentiment_transfer | 320/320 (100.0%) | 🔴 **0.71** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| options_composite | 320/320 (100.0%) | 🟡 **1.54** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| order_book_imbalance | 320/320 (100.0%) | 🔴 **0.84** | ~82 α/hr | 234 min | **?** | 🔴 0 候选 |
| price_signal_dl | 320/320 (100.0%) | 🔴 **0.81** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| pv_tech_indicators | 320/320 (100.0%) | 🔴 **0.76** | ~61 α/hr | 312 min | **?** | 🔴 0 候选 |
| quant_factor_lib | 320/320 (100.0%) | 🔴 **0.61** | ~81 α/hr | 238 min | **?** | 🔴 0 候选 |
...
| techindi_model | 320/320 (100.0%) | 🟡 **1.52** | ~62 α/hr | 312 min | **?** | 🔴 0 候选 |
| web_traffic_engage | 320/320 (100.0%) | 🟢 **2.27** | ~71 α/hr | 270 min | **?** | 🔴 0 候选 |
...
| 🚢 techindi_model | 320/320 (100%) | **?** | 中 |
| 🚢 web_traffic_engage | 320/320 (100%) | **?** | 中 |
| 🚢 workforce_flow_skills | 0/320 (0%) | **?** | 低(运行不足30min) |
| 🛡️ tri_track_undug | 3 alpha | **07-28 06:01** | 进度日志推算 |
...
| 预期完成 | **07-28 06:01** (基于每分片 ~300s × 6 剩余 / CONCURRENCY=3, 粗估) |
...
---
*报告由 `build_md_report.py` 从真实 checkpoint/progress/CSV 文件程序化生成 · 快照 2026-07-26 10:11 GMT+8 · 数字均来自文件实测，未编造。*
