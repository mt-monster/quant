> **数据快照**: 2026-07-26 18:38 GMT+8 ｜ **数据源**: `results/*_checkpoint.json`(权威) + `*_progress_*.log`(实时) + `tri_track_undug_results.csv`

> ⚠️ **提交验证最重要结论**：全部 **44** 个候选 Alpha 中，**1 个已正式提交**（`YPgAa3WR`，status=ACTIVE，dateSubmitted=2026-07-24，prod_corr=0.5325），剩余 **43** 个缺平台生产仿真(OOS)硬闸门验证、不可提交。`PASS_CHEAP` 仅表示本地廉价 IS 闸通过，不等于可提交。
...
| 指标 | 数值 | 说明 |
|---|---|---|
| 累计回测次数 | **13,779** | 全部 32 个 checkpoint 合计 |
| IS 廉价闸门通过 | **44** (40 PASS_CHEAP + 4 CHECK_PENDING) | 仅研究仿真 IS 闸通过，非「可提交」 |
...
每一级都是一道硬闸门：**IS 廉价闸门**筛掉 13,735 次（13,735/13779=99.7% 被筛）；**生产相关性关**仅 1 个通过；**平台提交**为 0。44 个候选 ≠ 可提交。
...
| 已提交 alpha | 累计 7688 次 (含研究仿真) | 84 alpha 已提交并完成 |
...
|---|---|---|---|---|---|---|
| ai_news_scores | 280/320 (87.5%) | 🔴 **0.77** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| analyst_earnings_ibes | 240/320 (75.0%) | 🟡 **1.35** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| chart_cnn_alpha | 8/320 (2.5%) | 🔴 **0.00** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| dl_riskfree_returns | 320/320 (100.0%) | 🟢 **2.33** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| earningscall_embed | 320/320 (100.0%) | 🟡 **1.05** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| earningscall_sentiment | 320/320 (100.0%) | 🟢 **1.67** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| equity_forum_data | 312/320 (97.5%) | 🟡 **1.26** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| equity_kpi_forecast | 320/320 (100.0%) | 🟡 **1.47** | ~84 α/hr | 230 min | **已完成** | 🔴 0 候选 |
| expected_move | 32/320 (10.0%) | 🔴 **0.00** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| filing_sentiment | 320/320 (100.0%) | 🟡 **1.32** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| finnews_nlp_scores | 296/320 (92.5%) | 🟡 **1.11** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| forum_sentiment | 264/320 (82.5%) | 🟡 **1.43** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| fundamental65 | 40/320 (12.5%) | 🔴 **0.00** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| ml_factor_proj | 320/320 (100.0%) | 🔴 **0.48** | ~61 α/hr | 317 min | **已完成** | 🔴 0 候选 |
| multi_horizon_alpha | 24/320 (7.5%) | 🔴 **0.00** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| news_sentiment_dl | 304/320 (95.0%) | 🔴 **0.68** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| news_sentiment_transfer | 320/320 (100.0%) | 🔴 **0.71** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| nlp_news_scores | 288/320 (90.0%) | 🟡 **1.27** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
...
| sentiment21 | 240/320 (75.0%) | 🔴 **0.66** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| sentiment22 | 320/320 (100.0%) | 🔴 **0.51** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| shortinterest6 | 128/320 (40.0%) | 🔴 **0.36** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
| shortinterest7 | 112/320 (35.0%) | 🔴 **0.30** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
...
| 🛡️ tri_track_undug | 84 alpha | **07-27 23:49** | 进度日志推算 |
...
| 7 |  rescue_r3_web_lift | 48 | 2 | 🟢 **2.11** | 候选 | gate_S/F/M/Ret |
...
| 16 | 🚢 ds_forum_sentiment_tri_forum_sentiment | 264 | 0 | 🟡 **1.43** | - | gate_S/F/M/Ret |
...
| 20 | 🚢 ds_nlp_news_scores_tri_nlp_news_scores | 288 | 0 | 🟡 **1.27** | - | gate_S/F/M/Ret |
| 21 | 🚢 ds_equity_forum_data_tri_equity_forum_da | 312 | 0 | 🟡 **1.26** | - | gate_S/F/M/Ret |
| 22 |  v53_tri_stock_search_trends | 320 | 0 | 🟡 **1.19** | - | gate_S/F/M/Ret |
| 23 |  v38_sust_profit | 278 | 0 | 🟡 **1.12** | - | gate_S/F/M/Ret |
| 24 | 🚢 ds_finnews_nlp_scores_tri_finnews_nlp_sc | 296 | 0 | 🟡 **1.11** | - | gate_S/F/M/Ret |
| 25 |  v38b_sust_rescue | 270 | 0 | 🟡 **1.07** | - | gate_S/F/M/Ret |
| 26 | 🚢 ds_earningscall_embed_tri_earningscall_e | 320 | 0 | 🟡 **1.05** | - | gate_S/F/M/Ret |
| 27 |  v37_other545 | 187 | 0 | 🔴 **0.98** | - | gate_S/F/M/Ret |
| 28 |  v54_tri_event_stock_model | 320 | 0 | 🔴 **0.95** | - | gate_S/F/M/Ret |
| 29 |  v46_tri_insider_trx | 320 | 0 | 🔴 **0.92** | - | gate_S/F/M/Ret |
| 30 |  v42_social | 200 | 0 | 🔴 **0.88** | - | gate_S/F/M/Ret |
...
| 33 |  v48_tri_acquisition_model | 320 | 0 | 🔴 **0.79** | - | gate_S/F/M/Ret |
| 34 | 🚢 ds_ai_news_scores_tri_ai_news_scores | 280 | 0 | 🔴 **0.77** | - | gate_S/F/M/Ret |
| 35 | 🚢 ds_pv_tech_indicators_tri_pv_tech_indica | 320 | 0 | 🔴 **0.76** | - | gate_S/F/M/Ret |
| 36 |  rescue_tvr | 120 | 0 | 🔴 **0.76** | - | gate_S/F/M/Ret |
| 37 |  v33_hkg_anl10 | 59 | 0 | 🔴 **0.76** | - | gate_S/F/M/Ret |
| 38 |  v41_earn_risk | 180 | 0 | 🔴 **0.75** | - | gate_S/F/M/Ret |
| 39 | 🚢 ds_news_sentiment_transfer_tri_news_sent | 320 | 0 | 🔴 **0.71** | - | gate_S/F/M/Ret |
| 40 |  v45_tri_insider_feats | 320 | 0 | 🔴 **0.69** | - | gate_S/F/M/Ret |
| 41 | 🚢 ds_news_sentiment_dl_tri_news_sentiment_ | 304 | 0 | 🔴 **0.68** | - | gate_S/F/M/Ret |
| 42 |  v50_tri_board_network | 320 | 0 | 🔴 **0.68** | - | gate_S/F/M/Ret |
| 43 | 🚢 ds_sentiment21_tri_sentiment21 | 240 | 0 | 🔴 **0.66** | - | gate_S/F/M/Ret |
| 44 |  v35_news_nlp | 24 | 0 | 🔴 **0.65** | - | gate_S/F/M/Ret |
| 45 |  v44_insider_feats | 200 | 0 | 🔴 **0.63** | - | gate_S/F/M/Ret |
| 46 | 🚢 ds_quant_factor_lib_tri_quant_factor_lib | 320 | 0 | 🔴 **0.61** | - | gate_S/F/M/Ret |
| 47 |  v36_stock_cluster | 157 | 0 | 🔴 **0.57** | - | gate_S/F/M/Ret |
| 48 | 🚢 ds_sentiment22_tri_sentiment22 | 320 | 0 | 🔴 **0.51** | - | gate_S/F/M/Ret |
| 49 | 🚢 ds_ml_factor_proj_tri_ml_factor_proj | 320 | 0 | 🔴 **0.48** | - | gate_S/F/M/Ret |
| 50 |  v43_event_rel | 200 | 0 | 🔴 **0.47** | - | gate_S/F/M/Ret |
| 51 |  v40_cre | 200 | 0 | 🔴 **0.43** | - | gate_S/F/M/Ret |
| 52 |  v49_tri_forward_beta_risk | 320 | 0 | 🔴 **0.43** | - | gate_S/F/M/Ret |
| 53 | 🚢 ds_shortinterest6_tri_shortinterest6 | 128 | 0 | 🔴 **0.36** | - | gate_S/F/M/Ret |
| 54 | 🚢 ds_shortinterest7_tri_shortinterest7 | 112 | 0 | 🔴 **0.30** | - | gate_S/F/M/Ret |
| 55 | 🚢 ds_chart_cnn_alpha_tri_chart_cnn_alpha | 8 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
| 56 | 🚢 ds_expected_move_tri_expected_move | 32 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
| 57 | 🚢 ds_fundamental65_tri_fundamental65 | 40 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
| 58 | 🚢 ds_multi_horizon_alpha_tri_multi_horizon | 24 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
| 59 |  measure_L2 | 3 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
| 60 |  measure_L3 | 2 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
| 61 |  measure_L | 6 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
| 62 |  measure_rate | 5 | 0 | 🔴 **0.00** | - | gate_S/F/M/Ret |
...
| 已提交 alpha | **84** 个  |
| 提交结果 | ✅ submitted=84 / ❌ failed=0 |
| 最佳 Sharpe | **1.59** |
| 分轨分布 | explore 45 / improve 39 / misc 0 |
| 时间范围 | ? ~ ? |
...
| 预期完成 | **07-27 23:49** (基于每分片 ~300s × 6 剩余 / CONCURRENCY=3, 粗估) |
...
| Ret(收益) | **10,339** | 20.6% |  |
| TVR(换手率) | **5,110** | 10.2% |  |
| submit_failed | **1,816** | 3.6% |  |
| PF:子宇宙Sharpe | **304** | 0.6% | 主因 PF:LOW_SUB_UNIVERSE_SHARPE (219次) |

> **PF:子宇宙 Sharpe 是头号平台失败闸门** (304 次)，印证'在子宇宙层面优化中性化/约束'是攻坚方向。IS 指标失败(夏普/拟合/换手/收益)合计 47,949 次，submit_failed 1,816 次(多为研究仿真本地拒，非平台 429)。

---
## 八、候选 Alpha 明细 (44 个，按 Sharpe 降序)
...
| 🔶 仍需进一步验证 | **43** | 43 个候选缺生产仿真(OOS)+submittable+submit |

> ⚠️ **实话实说**：全部 44 个候选，**1 个已提交、43 个不可提交**。`YPgAa3WR` 已验证 IS✅ + 生产相关性(0.5325)✅ + 风险中性✅ + 稳健性✅，已成功提交至 WQ 平台(status=ACTIVE)。其余 43 个均缺平台生产仿真(OOS)硬闸门——`/check` 返回空，提交即被静默丢弃。`PASS_CHEAP` ≈ 1/4 路程，`CHECK_PENDING` ≈ 1/2 路程。
...
1. **候选提交率 1/44**。仅 `YPgAa3WR` 已提交(ACTIVE)，其余 43 个缺平台 OOS 硬闸门。见第九章逐项审计。
...
5. **提交核查路线（按优先级）**：YPgAa3WR(最接近) → 4 个 CHECK_PENDING 等平台结果 → 40 个 PASS_CHEAP 排队验证。对 YPgAa3WR：跑 OOS → /check → submittable → submit(关 no_submit)；走通全流程后批量复制到其余候选。
...
---
*报告由 `build_md_report.py` 从真实 checkpoint/progress/CSV 文件程序化生成 · 快照 2026-07-26 18:38 GMT+8 · 数字均来自文件实测，未编造。*
