#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v55 待跑表达式本地约束校验 (纯本地, 不调 API, 不 import scan 模块避免副作用).
...
SCAN = os.path.join(_HERE, "scan_v55_glb_analyst10.py")
FIELDS_JSON = os.path.join(_HERE, "results", "glb_fields_analyst10.json")
