> **数据快照**: 2026-07-26 00:36 GMT+8 ｜ **数据源**: `results/*_checkpoint.json`(权威) + `*_progress_*.log`(实时) + `tri_track_undug_results.csv`
...
| 指标 | 数值 | 说明 |
|---|---|---|
| 累计回测次数 | **7,707** | 全部 32 个 checkpoint 合计 |
...
每一级都是一道硬闸门：**IS 廉价闸门**筛掉 7,665 次（7,665/7707=99.5% 被筛）；**生产相关性关**仅 1 个通过；**平台提交**为 0。42 个候选 ≠ 可提交。
...
| 已提交 alpha | 累计 1904 次 (含研究仿真) | 753 alpha 已提交并完成 |
...
|---|---|---|---|---|---|---|
| equity_kpi_forecast | 280/320 (87.5%) | 🟡 **1.42** | ~82 α/hr | 204 min | **07-26 01:05** | 🔴 0 候选 |
| ml_factor_proj | 240/320 (75.0%) | 🔴 **0.48** | ~70 α/hr | 205 min | **07-26 01:45** | 🔴 0 候选 |
| order_book_imbalance | 288/320 (90.0%) | 🔴 **0.84** | ~84 α/hr | 206 min | **07-26 00:59** | 🔴 0 候选 |
| pv_tech_indicators | 248/320 (77.5%) | 🔴 **0.76** | ~72 α/hr | 208 min | **07-26 01:36** | 🔴 0 候选 |
| quant_factor_lib | 272/320 (85.0%) | 🔴 **0.60** | ~79 α/hr | 206 min | **07-26 01:13** | 🔴 0 候选 |
| techindi_model | 240/320 (75.0%) | 🟡 **1.52** | ~70 α/hr | 205 min | **07-26 01:45** | 🔴 0 候选 |
| web_traffic_engage | 264/320 (82.5%) | 🟢 **2.27** | ~78 α/hr | 203 min | **07-26 01:19** | 🔴 0 候选 |
| workforce_flow_skills | 72/320 (22.5%) | 🔴 **0.91** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
...
| 任务 | 当前进度 | 预期完成 | 置信度 |
|---|---|---|---|
| 🚢 equity_kpi_forecast | 280/320 (88%) | **07-26 01:05** | 中 |
| 🚢 ml_factor_proj | 240/320 (75%) | **07-26 01:45** | 中 |
| 🚢 order_book_imbalance | 288/320 (90%) | **07-26 00:59** | 中 |
| 🚢 pv_tech_indicators | 248/320 (78%) | **07-26 01:36** | 中 |
| 🚢 quant_factor_lib | 272/320 (85%) | **07-26 01:13** | 中 |
| 🚢 techindi_model | 240/320 (75%) | **07-26 01:45** | 中 |
| 🚢 web_traffic_engage | 264/320 (82%) | **07-26 01:19** | 中 |
| 🚢 workforce_flow_skills | 0/320 (0%) | **?** | 低(运行不足30min) |
| 🛡️ tri_track_undug | 进度日志 | **07-26 00:46** | 中(进度日志推算) |
...
| 5 | 🚢 ds_web_traffic_engage_tri_web_traffic_en | 264 | 0 | 🟢 **2.27** | - | gate_S/F/M/Ret |
...
| 9 | 🚢 ds_techindi_model_tri_techindi_model | 240 | 0 | 🟡 **1.52** | - | gate_S/F/M/Ret |
| 10 | 🚢 ds_equity_kpi_forecast_tri_equity_kpi_fo | 280 | 0 | 🟡 **1.42** | - | gate_S/F/M/Ret |
...
| 17 | 🚢 ds_workforce_flow_skills_tri_workforce_f | 72 | 0 | 🔴 **0.91** | - | gate_S/F/M/Ret |
| 18 |  v42_social | 200 | 0 | 🔴 **0.88** | - | gate_S/F/M/Ret |
| 19 | 🚢 ds_order_book_imbalance_tri_order_book_i | 288 | 0 | 🔴 **0.84** | - | gate_S/F/M/Ret |
| 20 |  v48_tri_acquisition_model | 320 | 0 | 🔴 **0.79** | - | gate_S/F/M/Ret |
| 21 | 🚢 ds_pv_tech_indicators_tri_pv_tech_indica | 248 | 0 | 🔴 **0.76** | - | gate_S/F/M/Ret |
...
| 28 | 🚢 ds_quant_factor_lib_tri_quant_factor_lib | 272 | 0 | 🔴 **0.60** | - | gate_S/F/M/Ret |
| 29 |  v36_stock_cluster | 157 | 0 | 🔴 **0.57** | - | gate_S/F/M/Ret |
| 30 | 🚢 ds_ml_factor_proj_tri_ml_factor_proj | 240 | 0 | 🔴 **0.48** | - | gate_S/F/M/Ret |
...
| 已提交 alpha | **753** 个  |
| 提交结果 | ✅ submitted=753 / ❌ failed=0 |
| 最佳 Sharpe | 不可用 (CSV 无指标) |
| 分轨分布 | explore 428 / improve 221 / misc 104 |
| 时间范围 | 2026-07-25 11:58:04 ~ 2026-07-26 00:35:31 |
...
| 预期完成 | **07-26 00:46** (基于每分片 ~300s × 6 剩余 / CONCURRENCY=3, 粗估) |
...
| Ret(收益) | **5,980** | 20.5% |  |
| TVR(换手率) | **3,056** | 10.5% |  |
| submit_failed | **664** | 2.3% |  |
| PF:子宇宙Sharpe | **298** | 1.0% | 主因 PF:LOW_SUB_UNIVERSE_SHARPE (217次) |

> **PF:子宇宙 Sharpe 是头号平台失败闸门** (298 次)，印证'在子宇宙层面优化中性化/约束'是攻坚方向。IS 指标失败(夏普/拟合/换手/收益)合计 28,151 次，submit_failed 664 次(多为研究仿真本地拒，非平台 429)。
...
---
*报告由 `build_md_report.py` 从真实 checkpoint/progress/CSV 文件程序化生成 · 快照 2026-07-26 00:36 GMT+8 · 数字均来自文件实测，未编造。*
