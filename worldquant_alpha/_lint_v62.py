...
SCAN = os.path.join(_HERE, "scan_v62_glb_news73.py")
FIELDS_JSON = os.path.join(_HERE, "results", "glb_fields_news73.json")
...
labels = set()
STYLE_DECAYS = {"ent": [3, 6], "gsn": [3, 6], "cty": [3, 6], "cw": [3, 6], "spr": [3, 6], "vop": [3, 6], "cdd": [9, 12], "trk": [3, 6], "pwc": [6, 9, 12], "pw2": [6, 9], "rnk": [3, 6], "w44": [6, 9], "dw": [3, 6], "gnd": [3, 6], "zs": [3, 6], "cnt": [6, 9]}  # 与 scan_v60 STYLE_OVERRIDES 保持一致
for style, exprs in styles.items():
    for tag, expr in exprs:
