> **数据快照**: 2026-07-26 00:47 GMT+8 ｜ **数据源**: `results/*_checkpoint.json`(权威) + `*_progress_*.log`(实时) + `tri_track_undug_results.csv`
...
| 指标 | 数值 | 说明 |
|---|---|---|
| 累计回测次数 | **7,819** | 全部 32 个 checkpoint 合计 |
...
| 在飞挖掘任务 | **8 个任务** | 7路ds + 独立tri_track (v52b 已完成 160/160, 23:29) |
...
每一级都是一道硬闸门：**IS 廉价闸门**筛掉 7,777 次（7,777/7819=99.5% 被筛）；**生产相关性关**仅 1 个通过；**平台提交**为 0。42 个候选 ≠ 可提交。
...
| 已提交 alpha | 累计 2016 次 (含研究仿真) | 761 alpha 已提交并完成 |
...
|---|---|---|---|---|---|---|
| equity_kpi_forecast | 296/320 (92.5%) | 🟡 **1.42** | ~84 α/hr | 212 min | **07-26 01:05** | 🔴 0 候选 |
| ml_factor_proj | 256/320 (80.0%) | 🔴 **0.48** | ~71 α/hr | 216 min | **07-26 01:41** | 🔴 0 候选 |
| order_book_imbalance | 304/320 (95.0%) | 🔴 **0.84** | ~83 α/hr | 219 min | **07-26 00:59** | 🔴 0 候选 |
| pv_tech_indicators | 256/320 (80.0%) | 🔴 **0.76** | ~71 α/hr | 216 min | **07-26 01:41** | 🔴 0 候选 |
| quant_factor_lib | 288/320 (90.0%) | 🔴 **0.60** | ~80 α/hr | 216 min | **07-26 01:11** | 🔴 0 候选 |
| techindi_model | 248/320 (77.5%) | 🟡 **1.52** | ~71 α/hr | 211 min | **07-26 01:49** | 🔴 0 候选 |
| web_traffic_engage | 280/320 (87.5%) | 🟢 **2.27** | ~77 α/hr | 217 min | **07-26 01:18** | 🔴 0 候选 |
| workforce_flow_skills | 88/320 (27.5%) | 🔴 **0.92** | ~0 α/hr | 0 min | **?** | 🔴 0 候选 |
...
| 任务 | 当前进度 | 预期完成 | 置信度 |
|---|---|---|---|
| 🚢 equity_kpi_forecast | 296/320 (92%) | **07-26 01:05** | 中 |
| 🚢 ml_factor_proj | 256/320 (80%) | **07-26 01:41** | 中 |
| 🚢 order_book_imbalance | 304/320 (95%) | **07-26 00:59** | 中 |
| 🚢 pv_tech_indicators | 256/320 (80%) | **07-26 01:41** | 中 |
| 🚢 quant_factor_lib | 288/320 (90%) | **07-26 01:11** | 中 |
| 🚢 techindi_model | 248/320 (78%) | **07-26 01:49** | 中 |
| 🚢 web_traffic_engage | 280/320 (88%) | **07-26 01:18** | 中 |
| 🚢 workforce_flow_skills | 0/320 (0%) | **?** | 低(运行不足30min) |
| 🛡️ tri_track_undug | 进度日志 | **07-26 00:57** | 中(进度日志推算) |
...
| 5 | 🚢 ds_web_traffic_engage_tri_web_traffic_en | 280 | 0 | 🟢 **2.27** | - | gate_S/F/M/Ret |
...
| 9 | 🚢 ds_techindi_model_tri_techindi_model | 248 | 0 | 🟡 **1.52** | - | gate_S/F/M/Ret |
| 10 | 🚢 ds_equity_kpi_forecast_tri_equity_kpi_fo | 296 | 0 | 🟡 **1.42** | - | gate_S/F/M/Ret |
...
| 16 | 🚢 ds_workforce_flow_skills_tri_workforce_f | 88 | 0 | 🔴 **0.92** | - | gate_S/F/M/Ret |
| 17 |  v46_tri_insider_trx | 320 | 0 | 🔴 **0.92** | - | gate_S/F/M/Ret |
| 18 |  v42_social | 200 | 0 | 🔴 **0.88** | - | gate_S/F/M/Ret |
| 19 | 🚢 ds_order_book_imbalance_tri_order_book_i | 304 | 0 | 🔴 **0.84** | - | gate_S/F/M/Ret |
| 20 |  v48_tri_acquisition_model | 320 | 0 | 🔴 **0.79** | - | gate_S/F/M/Ret |
| 21 | 🚢 ds_pv_tech_indicators_tri_pv_tech_indica | 256 | 0 | 🔴 **0.76** | - | gate_S/F/M/Ret |
...
| 28 | 🚢 ds_quant_factor_lib_tri_quant_factor_lib | 288 | 0 | 🔴 **0.60** | - | gate_S/F/M/Ret |
| 29 |  v36_stock_cluster | 157 | 0 | 🔴 **0.57** | - | gate_S/F/M/Ret |
| 30 | 🚢 ds_ml_factor_proj_tri_ml_factor_proj | 256 | 0 | 🔴 **0.48** | - | gate_S/F/M/Ret |
...
| 已提交 alpha | **761** 个  |
| 提交结果 | ✅ submitted=761 / ❌ failed=0 |
| 最佳 Sharpe | 不可用 (CSV 无指标) |
| 分轨分布 | explore 436 / improve 221 / misc 104 |
| 时间范围 | 2026-07-25 11:58:04 ~ 2026-07-26 00:47:12 |
...
| 预期完成 | **07-26 00:57** (基于每分片 ~300s × 6 剩余 / CONCURRENCY=3, 粗估) |
...
| PF:子宇宙Sharpe | **298** | 1.0% | 主因 PF:LOW_SUB_UNIVERSE_SHARPE (217次) |

> **PF:子宇宙 Sharpe 是头号平台失败闸门** (298 次)，印证'在子宇宙层面优化中性化/约束'是攻坚方向。IS 指标失败(夏普/拟合/换手/收益)合计 28,628 次，submit_failed 664 次(多为研究仿真本地拒，非平台 429)。
...
---
*报告由 `build_md_report.py` 从真实 checkpoint/progress/CSV 文件程序化生成 · 快照 2026-07-26 00:47 GMT+8 · 数字均来自文件实测，未编造。*
