...
SCAN = os.path.join(_HERE, "scan_v65_glb_inst18.py")
FIELDS_JSON = os.path.join(_HERE, "results", "glb_fields_institutions18.json")
...
labels = set()
STYLE_DECAYS = {"chg": [0, 3], "dif": [0, 3], "lvl": [3, 6], "sm": [0, 3], "cty": [0, 3]}  # 与 scan_v60 STYLE_OVERRIDES 保持一致
for style, exprs in styles.items():
    for tag, expr in exprs:
