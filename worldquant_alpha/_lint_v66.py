...
SCAN = os.path.join(_HERE, "scan_v66_glb_decorr.py")
FIELDS_JSON = os.path.join(_HERE, "results", "glb_fields_predictive_starmine.json")
...
labels = set()
STYLE_DECAYS = {"nt": [3, 6], "grp": [3, 6], "tsr": [3, 6], "tsz": [3, 6], "gn": [3, 6], "acc": [0, 3], "pw": [3, 6]}  # 与 scan_v60 STYLE_OVERRIDES 保持一致
for style, exprs in styles.items():
    for tag, expr in exprs:
