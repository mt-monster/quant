...
SCAN = os.path.join(_HERE, "scan_v60_glb_seasonal.py")
FIELDS_JSON = os.path.join(_HERE, "results", "glb_fields_global_seasonal_model.json")
...
labels = set()
STYLE_DECAYS = {"tsr": [3, 6], "anl2": [3, 6], "anl3": [6, 9], "anl4": [3, 6], "anl5": [3, 6], "anl6": [3, 6], "anl7": [9, 12], "anl8": [3, 6], "anl9": [3, 6], "anl10": [0, 3], "anl11": [0, 3], "anl12": [0, 3], "anl13": [0, 3], "anl14": [0, 3], "anl15": [0, 3], "anl16": [6, 9, 12], "anl17": [6, 9, 12]}  # 与 scan_v60 STYLE_OVERRIDES 保持一致
for style, exprs in styles.items():
    for tag, expr in exprs:
