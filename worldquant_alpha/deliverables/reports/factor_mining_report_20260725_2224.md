...
| 已提交 alpha | 累计 648 次 (含研究仿真) | 600 alpha 已提交并完成 |
...
| 已提交 alpha | **600** 个 (全部 status=done) |
| 分轨分布 | explore 346 / improve 150 / misc 104 |
| 时间范围 | 2026-07-25 11:58:04 ~ 2026-07-25 22:23:55 |
| 结果文件 | `tri_track_undug_results.csv` (601 行) |
