...
SCAN = os.path.join(_HERE, "scan_v64_glb_rate327.py")
FIELDS_JSON = os.path.join(_HERE, "results", "glb_fields_other327.json")
...
labels = set()
STYLE_DECAYS = {"lvl": [0, 3], "dlt": [0, 3], "spr": [0, 3], "cty": [0, 3]}  # 与 scan_v60 STYLE_OVERRIDES 保持一致
for style, exprs in styles.items():
    for tag, expr in exprs:
