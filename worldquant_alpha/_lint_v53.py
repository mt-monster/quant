#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v53d 待跑表达式本地约束校验 (纯本地, 不调 API, 不 import scan 模块避免副作用).
...
SCAN = os.path.join(_HERE, "scan_v53_glb_intraday.py")
FIELDS_JSON = os.path.join(_HERE, "results", "glb_fields_intraday_pv_feats.json")
...
UNIVERSES = ["MINVOL1M", "TOPDIV3000"]; DECAYS = [6, 10]
